<template>
  <AppLayout>
    <div class="editor-analysis-view">
      <div class="view-header">
        <h1 class="view-title">Editor Analysis</h1>
        <p class="view-description">
          Analyze Copilot usage patterns across different code editors.
        </p>
      </div>
      ...
      <div v-else-if="!metrics" class="empty-state">
        <p>No editor data available. Please check your connection or try again later.</p>
      </div>
...
const isLoading = computed(() => !store.state.CopilotUsage?.metricsReady)
const error = computed(() => store.state.CopilotUsage?.apiError || null)
